...
country = {
	...
	MIN_DELAY_BETWEEN_REFORMS = 0, -- months
	ECONOMIC_REFORM_UH_FACTOR = -0.40, -- -0.40,
	MILITARY_REFORM_UH_FACTOR = -0.40, -- -0.40,
...
ai =
{
	...
	PEACE_WAR_EXHAUSTION_FACTOR = 2, -- AI willingness to peace based on war exhaustion
	PEACE_WAR_DIRECTION_FACTOR = 3.0, -- AI willingness to peace based on who's making gains in the war
	...
	PEACE_ALLY_TIME_MULT = 1, -- Multiplies PEACE_TIME_FACTOR for allies in a war
